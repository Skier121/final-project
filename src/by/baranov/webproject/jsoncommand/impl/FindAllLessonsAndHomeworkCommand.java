...
public class FindAllLessonsAndHomeworkCommand implements JsonCommand {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response){
        ...
        try {
            result = "[" + SubjectService.findAllLessonAndHomework(parentId).stream().map(TimetableAndHomeworkDto::toString)
